        ...
        <article className="min-w-0 max-w-3xl space-y-16">
          ...
          <section className="space-y-4">
            ...
            <CodeBlock
              filename="terminal"
              code={`# pnpm
pnpm add @websearch-sdk/core @websearch-sdk/firecrawl

# npm
npm install @websearch-sdk/core @websearch-sdk/firecrawl
...
pnpm add ai`}
          ...
          <section className="space-y-4">
            ...
            <CodeBlock
              ...
              code={`import { WebSearch } from "@websearch-sdk/core";
...
const { text } = await generateText({
  ...
  prompt: "Find the latest stable pnpm version and summarize what changed.",
          ...
          <section className="space-y-4">
            ...
            <CodeBlock
              filename="errors.ts"
              code={`import { MissingApiKeyError, isMissingApiKeyError } from "@websearch-sdk/core";
...
interface SearchResult {
  ...
  raw?: unknown;
          ...
          <section className="space-y-4">
            ...
            <CodeBlock
              code={`@websearch-sdk/core         WebSearch class + unified types + provider
...
@websearch-sdk/<provider>   firecrawl · tavily · exa · brave · serper`}
          ...
          <section className="space-y-4">
            ...
            <CodeBlock
              ...
              code={`import type { SearchProvider } from "@websearch-sdk/core";
